...
export const menuBars = geohash => fetch('/menu/index_entry', {
	geohash,
	group_type: '1',
	'flags[]': 'F'
});
export const powerDa= (sbbId, dateFrom, dateTo) => fetch('/power/list', {
  sbbId,
  dateFrom,
  dateTo
});

export const getRealList= (sbbId, type, itemType) => fetch('/gap/realList', {
  sbbId,
  type,
  itemType
});

export const deviceList = (userId) => fetch('/common/deviceList', {userId});
export const device2List = (userId) => fetch('/common/device2List', {userId});
export const otherDa= (sbbId, dateFrom, dateTo,  pageNo, pageSize,userId) => fetch('/other/list', {
  sbbId,
  dateFrom,
  dateTo,
  pageNo,
...
export const alertDa= (sbbId, dateFrom, dateTo,delFlag, pageNo, pageSize,userId) => fetch('/alert/list', {
  sbbId,
  dateFrom,
  dateTo,
  delFlag,
...
export const getYearList= (sbbId, dateFrom, dateTo, itemType) => fetch('/gap/yearList', {
  sbbId,
  dateFrom,
  dateTo,
  itemType
...
export const getMonthList= (sbbId, dateFrom, dateTo, itemType) => fetch('/gap/monthList', {
  sbbId,
  dateFrom,
  dateTo,
  itemType
...
export const getDayList= (sbbId,  dateTo, itemType) => fetch('/gap/dayList', {
  sbbId,
  dateTo,
  itemType
});
 ...
 * 账号密码登录
 */
export const accountLogin = (username, password) => fetch('/user/login', {username, password});
/**
 * 获取msite商铺列表
 */
