<template>
    <section id='foot_guide'>
        ...
        <section @click = "gotoAddress({path: '/main', query: {geohash}})" class="guide_item">
        	<svg class="icon_style">
                <use xmlns:xlink="http://www.w3.org/1999/xlink" :xlink:href="$route.path.indexOf('msite') !== -1? '#msiteActive' : '#find'"></use>
            </svg>
            <span>首页</span>
        </section>
      <!--  <section @click = "gotoAddress({path: '/search/geohash'})" class="guide_item">-->
      <section @click = "gotoAddress({path: '/data'})" class="guide_item">
        	<svg class="icon_style">
