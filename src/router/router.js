...
const data = r => require.ensure([], () => r(require('../page/data/data')), 'data')
...
const powerData = r => require.ensure([], () => r(require('../page/powerData/powerData')), 'powerData')
const alertData = r => require.ensure([], () => r(require('../page/alertData/alertData')), 'alertData')
const otherData = r => require.ensure([], () => r(require('../page/otherData/otherData')), 'otherData')
const showLine = r => require.ensure([], () => r(require('../page/showLine/showLine')), 'showLine')
const yearData = r => require.ensure([], () => r(require('../page/yearData/yearData')), 'yearData')
const srhPD = r => require.ensure([], () => r(require('../page/search/srhPD')), 'srhPD')
const srhMonth = r => require.ensure([], () => r(require('../page/month/srhMonth')), 'srhMonth')
const monthData = r => require.ensure([], () => r(require('../page/month/monthData')), 'monthData')
const realData = r => require.ensure([], () => r(require('../page/real/realData')), 'realData')
const srhReal = r => require.ensure([], () => r(require('../page/real/srhReal')), 'srhReal')
const srhDay = r => require.ensure([], () => r(require('../page/day/srhDay')), 'srhDay')
