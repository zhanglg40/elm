<template>
  ...
  <head-top  head-title="其他数据查询" goBack="true"></head-top>
...
<script>
  ...
  import SbbList from 'src/components/common/Sbb2List'
    ...
    export default {
      ...
      methods: {
        ...
        search(){
          ...
          this.$router.push({ path: '/otherData' ,query:{sbbId:this.sbbId,dateFrom:this.dateFrom,dateTo:this.dateTo}})
        }
      }
    }
</script>
