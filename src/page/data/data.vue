<template>
    <div class="profile_page">
      <head-top head-title="数据列表" ></head-top>
            ...
            <section class="profile-1reTe">
                <!-- 服务中心 -->
                <router-link to='/srhPD' class="myorder">
                    <aside>
                        <svg fill="#4aa5f0">
      ...
      <section class="profile-1reTe">
        <!-- 服务中心 -->
        <router-link to='/srhOH' class="myorder">
          <aside>
            <svg fill="#4aa5f0">
              <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#service"></use>
            </svg>
      ...
      <section class="profile-1reTe">
        <!-- 服务中心 -->
        <router-link to='/alertData' class="myorder">
          <aside>
            <svg fill="#4aa5f0">
              <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#service"></use>
            </svg>
